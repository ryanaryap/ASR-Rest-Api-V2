...
def search_lk21(query):
	url = lk21 = bs(get('https://lk21.asia/?s=%s#gsc.tab=0&gsc.q=resident&gsc.page=1' % query, headers=usr_agent).text, 'html.parser').find('div', class_='search-content').a['href']
	return url
